...
\textcolor{blue}{
\subsubsection{Angestrebte Ausgabe} \index{angestrebte Ausgabe} \label{angestrebte Ausgabe}
...
\end{itemize}
\includegraphics[scale = 0.5]{Graphics/Logische_Generalisierungsoptimierung}\label{Abb_Log_Gen}
\begin{figure}[h]
