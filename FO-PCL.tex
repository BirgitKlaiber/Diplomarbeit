...
\addtolength{\currentLongTableWidth}{-4\tabcolsep} %subtrahiere -8\cdot textbreite von asdf, 2 Abstände pro Zelle * Anzahl der Spalte
\begin{footnotesize}
	\begin{longtable}{| >{\raggedright} p {0.2\currentLongTableWidth} |>{\raggedright} p {0.4\currentLongTableWidth} |>{\raggedright} p {0.4\currentLongTableWidth} | p {0.0\currentLongTableWidth} |}
		\hline
		\multicolumn{4}{|c|}{\textbf{Anfrage ist ein Atom}}\\\hline\hline
		\hline
			\textbf{Prädikate} 
			& \textbf{Beispiel} 
			& \textbf{Anfrage} 
		...
		\hline
			\caption{Übersicht zur Auswertung der Klassen}
	\end{longtable}
\end{footnotesize}

\subsubsection {Eine Äquivalenzklassen und die Anfrage ist eine (nichtatomare, logische) Formel}
...
\addtolength{\currentLongTableWidth}{-4\tabcolsep} %subtrahiere -8\cdot textbreite von asdf, 2 Abstände pro Zelle * Anzahl der Spalte
\begin{footnotesize}
	\begin{longtable}{| >{\raggedright} p {0.2\currentLongTableWidth} | p {0.4\currentLongTableWidth} |>{\raggedright} p {0.4\currentLongTableWidth} | >{\raggedright} p {0.0\currentLongTableWidth} |}
		\hline
		\multicolumn{4}{|c|}{\textbf{Anfrage ist ein Atom}}\\\hline\hline
		\hline
		\textbf{Prädikate} 
...
TODO:
\subsubsection {Zwei Äquivalenzklassen mit je einem Konditional}
TODO:
\subsubsection {Zwei Äquivalenzklassen, bei der eine Klasse ein Konditional enthält und die andere Klasse mehr als ein Konditional}
...
\section{Konditionale Generalisierung}
\textcolor{blue}{
\subsection{Vorüberlegungen}
