...
\begin{Bsp}[Positive Generalisierung am Beispiel "{}ColdSpez{}, s. \ref{ColdSpez}]\label{PosGen_ColdSpez}
...
\begin{Bsp}[Negative Generalisierung am Beispiel ColdSpez, s. \ref{ColdSpez}]
	Für die Anfrage (contact(X,Y) * cold(Y)) ergibt sich:\\
