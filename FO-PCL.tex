...
\begin{itemize}
 \item{Misanthrope3Classes}	\label{BMisanthrope3Classes} s. \ref{Misanthrope3Classes}:\\
 Für jede spezifische Konstante ergeben die spezifischen Grundinstanzen eine eigene Klasse. Die generischen Grundinstanzen haben die gleiche Wahrscheinlichkeit, mit Ausnahme der reflexiven Instanzen.
\end{itemize}
}
\end{itemize}
...
\textcolor{green}{
\paragraph{Mehr als zwei Äquivalenzklassen und die Anfrage ist eine (nichtatomare, logische) Formel}
TODO
}
\setlength{\currentLongTableWidth}{\textwidth} %setze neue länge auf textbreite
\addtolength{\currentLongTableWidth}{-4\tabcolsep} %subtrahiere -8\cdot textbreite von asdf, 2 Abstände pro Zelle * Anzahl der Spalte
...
\textcolor{green}{
\section{Misanthrope3Classes} Erläuterungen s. \ref{BMisanthrope3Classes}
\label{Misanthrope3Classes}
\lstinputlisting{Examples/Misanthrope3Classes.txt}
}
\newpage
