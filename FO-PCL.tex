...
\begin{center}
\textcolor{blue}{Version 20171225}
...
\begin{Def}[Generalisierung]\index{Generalisierung} \label{Generalisierung}
	Sei $\cal{R}$ eine FO-PCL Wissensbasis, $ \cal{Q} $ eine Anfrage in Form eines unbedingten Konditionals. Unter einer Generalisierung versteht man den Prozess, für eine Äquivalenzklasse von Konditionalen ein einziges Konditional zu erzeugen, das die Klasse repräsentiert und alle Konditionale erfasst. 
\end{Def}
