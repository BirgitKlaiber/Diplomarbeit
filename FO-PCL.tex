...
\begin{center}
\textcolor{blue}{Version 20171123}
...
\textcolor{blue}{
	\section{Modifikation des Versionenraum-Lernverfahrens} \label{Verwendbar VRL} \index{Versionenraum-Lernverfahren}
