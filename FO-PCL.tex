...
Das Ziel des Algorithmus ist die Generierung einer Rückgabemenge von bedingten Konditionalen, die n Grundkonditionalen mit gleicher Wahrscheinlichkeit und sollte möglichst allgemein sein. Unter einem allgemeinen Konditional im Sinne dieser Arbeit versteht man ein möglichst kurzes Konditional. Ein Konditional ist möglichst kurz, wenn der logische Constraint eine möglichst einfache Formel ist, also nur so viele atomare Ausdrücke und Junktoren wie unbedingt nötig enthält.
...
\textbf{{\Large Fazit zur positiven Generalisierung:}}\index{Generalisierung ! positiv}
\noindent
...
\textbf{{\Large Fazit zur negativen Generalisierung:}}\index{Generalisierung ! negativ}
...
\begin{itemize}
	\item Positive Generalisierung \index{Generalisierung ! positiv}
	\item Negative Generalisierung \index{Generalisierung ! negativ}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\begin{Bsp}[Konditionale Generalisierung für mehrere Klassen am Beispiel "{}Misanthrope"{}] \index{Generalisierung ! konditional}
			...
			\end{Bsp} 
			\begin{Bsp}[Konditionale Generalisierung für mehrere Klassen am Beispiel "{}ColdSpez"{}] \index{Generalisierung ! konditional}
...
\begin{Bsp}[Beispielhafte Vorgehensweise des Algorithmus]
	...
	\begin{enumerate}
		...
		\item Generalisierung der Äquivalenzklassen. \index{Generalisierung}
		\begin{quote}
