...
\textcolor{blue}{
\begin{Def}[Spezifische Konstanten, spezifisches Konditional] \index{Konstante ! spezifisch} \index{Konditional ! spezifisch} \label{Konstanten spezifisch}
...
\\
\\
Die Menge $ spezGnd(R) $ der zulässigen spezifischen Grundinstanzen von $ R $ ist definiert als eine Teilmenge der zulässigen Grundinstanzen, die eine spezifische Konstante enthalten.
\end{Def}
}
