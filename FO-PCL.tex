...
\begin{center}
\textcolor{blue}{Version 20180726}
...
Das ist der trivialste Fall. In diesem Fall besteht die Rückgabemenge aus dem quantifizierten Konditional ohne Constraint.
	\begin{Bsp}[Konditionale Generalisierung am Beispiel]
	Die konditonale Generalisierung soll für das Beispiel  "{}BirdsWithoutNull"{}, s. \ref{BirdsWihoutNull}, gezeigt werden:\\
...
Die Vorgehensweise des Algorithmus wird wie folgt anhand des einfachen Beispiels \ref{sec:Misanthrop} "{}Misanthrope"{} erläutert,vgl. auch \ref{Misanthrope}.
...
\includegraphics[scale = 1.0]{Graphics/Beispiel_unausfuehrbar}
\begin{figure}[h]
