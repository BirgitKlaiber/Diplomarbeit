...
\begin{center}
\textcolor{blue}{Version 20180919}
...
\newpage
\includegraphics[scale = 1.0]{Graphics/Flussplan_Generalisierung_kond_B}
\begin{figure}[h!]
...
Man unterscheidet im allgemeinen zwischen spezifischen und generischen Grundinstanzen einer Formel, \index{Grundinstanz ! generisch} \index{Grundinstanz ! spezifisch} \ref{Grundinstanz spezifisch}.
...
Dieser Entwurf wurde in der Implementation, \ref{Inf} umgesetzt. Die Ergebnisse der Umsetzung und die dabei aufgetretenen Herausforderungen, gemeisterten Schwierigkeiten und gefundenen Lösungen wurden in \ref{eval} diskutiert und dokumentiert. 
