...
\begin{center}
\textcolor{blue}{Version 20180914}
...
Wie sich herausgestellt hat, ließen sich die favorisierte Idee der konditionalen Generalisierung in einen Entwurf umsetzen und auch praktisch mit verhältnismäßigem Aufwand realisieren, d.h. implementieren. Andere viel versprechende Ideen wie die logische Generalisierung, \ref{Logische Generalisierung} und das modifizierte Versionenraum-Verfahren, \ref{Verwendbar VRL} mussten verworfen werden. 
